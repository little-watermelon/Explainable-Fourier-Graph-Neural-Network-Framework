...
from data.data_loader import Dataset_shalegas
...
parser.add_argument('--data', type=str, default='SHALEGAS', help='data set')
...
data_parser = {
    ...
    'SHALEGAS':{'root_path':'data/shalegas_data.csv', 'type':'1'},
